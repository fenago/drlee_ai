...
export const metadata: Metadata = {
  title: 'Build Your Own LLM (Original) | DrLee.ai Masterclass',
  description: 'The original course page for Build Your Own Large Language Model masterclass.',
};
...
export default function LargeLanguageModels2Page() {
  const course = getCourseBySlug('large-language-models');
