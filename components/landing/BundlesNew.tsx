...
const bundles = [
  ...
  },
  {
    ...
    description: "All 26 Hardcore Developer courses—from ML fundamentals to frontier AI systems",
    courses: 26,
    hours: 1020,
    pricing: {
    ...
    includes: [
      "All 26 Hardcore Developer courses",
  ...
  },
  {
    ...
    description: "All 32 masterclasses—complete access to the entire DrLee.ai curriculum",
    courses: 32,
    hours: 1174,
    pricing: {
    ...
    includes: [
      "All 32 masterclasses",
      "Hardcore Developer (26 courses)",
      "Citizen Developer (6 courses)",
