...
const config = {
  ...
  appDescription:
    "Master AI from first principles. Premium masterclasses for founders, engineers, and leaders who want to build—not just use—the technology reshaping the world.",
    ...
    plans: [
      {
        ...
        features: [
          ...
          { name: "Lifetime access to materials" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Weekly office hours with instructor" },
          { name: "Private cohort community" },
          { name: "Code reviews & feedback" },
          { name: "Direct access to Dr. Lee" },
        ],
      },
      {
        priceId:
        ...
        features: [
          ...
          { name: "Custom project code reviews" },
          { name: "Implementation consulting" },
          { name: "Lifetime alumni network access" },
          { name: "Priority support & updates" },
        ],
      },
    ],
  },
  ...
  resend: {
    ...
    fromNoReply: `DrLee.ai <noreply@drlee.ai>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `Dr. Lee <drlee@drlee.ai>`,
    // Email shown to customer if they need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "support@drlee.ai",
  },
  colors: {
